...
const TopDoctors = () => {
   const { doctors } = useContext(AppContext);   // 👈 fetch from context
  const navigate = useNavigate()

  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10 '>
      <h1 className='text-3xl font-medium'>Top Doctors to Book</h1>
      <p className='sm:w-1/3 text-centre text-center'>Browse through our extensive list of trusted doctors. </p>
