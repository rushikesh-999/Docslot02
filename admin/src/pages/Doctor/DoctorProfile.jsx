      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {/* ----Doc Info : name, degree,experience ----*/}
           ...
           <p className='flex items-center gap-2 text-3xl font-medium text-gray-900'>{profileData.name}</p>
           ...
           {/* ---Doc About--- */}
           <div>
            <p className='flex items-center gap-1 text-sm font-medium text-blue-500 mt-3'>About</p>
           ...
           <div className='flex flex gap-1 pt-2'>
